...
func TestRouteInventoryAndAuthentication(t *testing.T) {
	...
	protected := []struct{ method, pattern, request string }{
		...
		{"POST", "/v1/invitaciones/:token/aceptar", "/v1/invitaciones/token/aceptar"},
		{"GET", "/v1/marcas/:brand_id/personal", "/v1/marcas/1/personal"},
		{"GET", "/v1/marcas/:brand_id/personal/:resource_id", "/v1/marcas/1/personal/1"},
		{"PATCH", "/v1/marcas/:brand_id/personal/:resource_id", "/v1/marcas/1/personal/1"},
		{"DELETE", "/v1/marcas/:brand_id/personal/:resource_id", "/v1/marcas/1/personal/1"},
